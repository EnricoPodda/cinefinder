...
data class Movie(val title: String, val description: String, val cast: ArrayList<String>, val releaseDate: String, val length: String, val image: String, val standard: Boolean = true) {
